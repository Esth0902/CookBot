...
('2024-09-15 16:40:18', 400, 600, 200, 800, 1),
('2024-09-18 11:29:08', 260, 320, 280, 600, 1),
('2024-09-20 08:14:55', 310, 410, 330, 740, 1),
('2024-09-24 19:48:18', 150, 230, 260, 490, 1),
('2024-09-28 07:56:44', 210, 500, 300, 800, 1);

-- ============================
-- USER 1 — OCTOBRE (10)
-- ============================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                        ('2024-10-02 13:22:09', 180, 400, 350, 750, 1),
                                       ('2024-10-04 17:16:32', 240, 520, 310, 830, 1),
                                    ('2024-10-07 20:40:18', 320, 300, 420, 720, 1),
                          ('2024-10-11 11:12:03', 100, 120, 200, 320, 1),
                                                                                                         ('2024-10-14 09:23:45', 410, 560, 260, 820, 1),
                                                                                                         ('2024-10-17 22:14:50', 350, 470, 310, 780, 1),
                                                                                                         ('2024-10-19 06:33:28', 270, 340, 280, 620, 1),
                                                                                                         ('2024-10-22 12:48:11', 200, 420, 250, 670, 1),
                                                                                                         ('2024-10-26 15:03:09', 310, 380, 320, 700, 1),
                                                                                                         ('2024-10-29 18:54:44', 130, 200, 170, 370, 1);

-- ============================
-- USER 1 — NOVEMBRE (10)
-- ============================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                                                                                                         ('2024-11-01 10:10:45', 230, 440, 300, 740, 1),
                                                                                                         ('2024-11-04 14:33:22', 350, 330, 410, 740, 1),
                                                                                                         ('2024-11-06 16:18:59', 200, 280, 260, 540, 1),
                                                                                                         ('2024-11-09 08:25:17', 150, 150, 300, 450, 1),
                                                                                                         ('2024-11-12 21:15:44', 420, 520, 350, 870, 1),
                                                                                                         ('2024-11-15 19:50:03', 390, 610, 220, 830, 1),
                                                                                                         ('2024-11-18 07:14:55', 260, 360, 290, 650, 1),
                                                                                                         ('2024-11-21 11:33:28', 180, 230, 310, 540, 1),
                                                                                                         ('2024-11-25 13:48:14', 300, 430, 280, 710, 1),
                                                                                                         ('2024-11-28 20:40:51', 140, 300, 200, 500, 1);
...
-- =======================================================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                                                                                                         ('2024-09-02 08:12:23', 310, 430, 360, 790, 2),
                                                                                                         ('2024-09-04 12:45:55', 200, 520, 260, 780, 2),
                                                                                                         ('2024-09-07 17:20:01', 150, 230, 340, 570, 2),
                                                                                                         ('2024-09-10 09:30:12', 180, 410, 300, 710, 2),
                                                                                                         ('2024-09-13 13:41:40', 300, 340, 320, 660, 2),
                                                                                                         ('2024-09-17 10:28:18', 220, 380, 310, 690, 2),
                                                                                                         ('2024-09-19 20:50:34', 400, 600, 260, 860, 2),
                                                                                                         ('2024-09-22 07:22:14', 110, 120, 220, 340, 2),
                                                                                                         ('2024-09-25 15:44:09', 350, 410, 390, 800, 2),
                                                                                                         ('2024-09-29 18:58:55', 260, 310, 310, 620, 2);

-- =======================================================
-- USER 2 — OCTOBRE (10)
-- =======================================================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                                                                                                         ('2024-10-01 11:22:11', 170, 320, 260, 580, 2),
                                                                                                         ('2024-10-05 19:34:44', 340, 430, 310, 740, 2),
                                                                                                         ('2024-10-08 09:14:27', 210, 350, 240, 590, 2),
                                                                                                         ('2024-10-10 14:48:55', 290, 480, 310, 790, 2),
                                                                                                         ('2024-10-13 08:22:33', 400, 550, 300, 850, 2),
                                                                                                         ('2024-10-16 10:35:18', 260, 380, 280, 660, 2),
                                                                                                         ('2024-10-20 21:00:03', 300, 430, 330, 760, 2),
                                                                                                         ('2024-10-23 13:18:40', 200, 290, 270, 560, 2),
                                                                                                         ('2024-10-27 07:44:51', 330, 500, 340, 840, 2),
                                                                                                         ('2024-10-30 16:55:09', 120, 150, 190, 340, 2);

-- =======================================================
-- USER 2 — NOVEMBRE (10)
-- =======================================================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                                                                                                         ('2024-11-03 10:32:02', 300, 480, 310, 790, 2),
                                                                                                         ('2024-11-05 18:25:41', 320, 520, 250, 770, 2),
                                                                                                         ('2024-11-08 14:12:31', 250, 330, 300, 630, 2),
                                                                                                         ('2024-11-11 09:44:22', 110, 120, 260, 380, 2),
                                                                                                         ('2024-11-14 21:56:08', 450, 600, 330, 930, 2),
                                                                                                         ('2024-11-17 06:22:45', 380, 510, 260, 770, 2),
                                                                                                         ('2024-11-20 11:34:55', 230, 300, 310, 610, 2),
                                                                                                         ('2024-11-23 12:48:14', 190, 230, 250, 480, 2),
                                                                                                         ('2024-11-26 16:15:33', 330, 490, 290, 780, 2),
                                                                                                         ('2024-11-29 19:08:21', 140, 200, 180, 380, 2);
...
-- =======================================================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                                                                                                         ('2024-09-01 07:15:33', 100, 150, 200, 350, 3),
                                                                                                         ('2024-09-03 12:18:29', 240, 400, 280, 680, 3),
                                                                                                         ('2024-09-06 16:55:11', 300, 520, 310, 830, 3),
                                                                                                         ('2024-09-09 10:44:02', 200, 330, 260, 590, 3),
                                                                                                         ('2024-09-12 21:30:59', 350, 470, 290, 760, 3),
                                                                                                         ('2024-09-16 08:25:21', 160, 200, 250, 450, 3),
                                                                                                         ('2024-09-18 19:52:14', 420, 600, 260, 860, 3),
                                                                                                         ('2024-09-21 11:45:33', 260, 360, 290, 650, 3),
                                                                                                         ('2024-09-26 15:12:09', 310, 410, 320, 730, 3),
                                                                                                         ('2024-09-30 18:30:44', 130, 180, 200, 380, 3);

-- =======================================================
-- USER 3 — OCTOBRE (10)
-- =======================================================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                                                                                                         ('2024-10-03 10:14:55', 210, 350, 300, 650, 3),
                                                                                                         ('2024-10-06 13:48:28', 340, 480, 330, 810, 3),
                                                                                                         ('2024-10-09 20:44:03', 270, 390, 280, 670, 3),
                                                                                                         ('2024-10-12 07:11:40', 190, 260, 240, 500, 3),
                                                                                                         ('2024-10-15 14:33:59', 300, 420, 310, 730, 3),
                                                                                                         ('2024-10-18 11:42:22', 150, 200, 260, 410, 3),
                                                                                                         ('2024-10-21 16:18:09', 430, 560, 320, 880, 3),
                                                                                                         ('2024-10-24 22:50:45', 360, 440, 350, 790, 3),
                                                                                                         ('2024-10-27 06:44:19', 300, 330, 290, 620, 3),
                                                                                                         ('2024-10-31 17:34:03', 140, 180, 210, 390, 3);

-- =======================================================
-- USER 3 — NOVEMBRE (10)
-- =======================================================
insert into metrics (creation_date, execution_time, input_token, output_token, total_token, user_id) values
                                                                                                         ('2024-11-02 12:10:22', 240, 400, 260, 660, 3),
                                                                                                         ('2024-11-05 09:23:41', 300, 450, 310, 760, 3),
                                                                                                         ('2024-11-07 14:18:09', 260, 320, 310, 630, 3),
                                                                                                         ('2024-11-10 22:30:51', 420, 600, 350, 950, 3),
                                                                                                         ('2024-11-13 19:48:25', 310, 430, 300, 730, 3),
                                                                                                         ('2024-11-16 08:33:18', 150, 200, 260, 410, 3),
                                                                                                         ('2024-11-19 07:55:59', 380, 520, 280, 800, 3),
                                                                                                         ('2024-11-22 16:44:03', 290, 340, 310, 650, 3),
                                                                                                         ('2024-11-25 11:58:14', 210, 300, 240, 540, 3),
                                                                                                         ('2024-11-28 20:33:47', 140, 180, 190, 370, 3);