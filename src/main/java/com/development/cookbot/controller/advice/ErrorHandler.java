package com.development.cookbot.controller.advice;

import com.development.cookbot.exception.BadRequestCustomException;
import com.development.cookbot.exception.DataExistException;
import com.development.cookbot.exception.ForbiddenCustomException;
...
public class ErrorHandler {
    ...
    public final ResponseEntity<Response<Object>> handleForbiddenCustomException(ForbiddenCustomException ex) {
        List<String> errors = Collections.singletonList(ex.getMessage());
